...
class PenjualanController extends Controller
{
    ...
    public function tampil(){
        ...
        if(!Session::get('login')){
            ...
            return view('penjualan/penjualan',['user'=>$user, 'produk'=>$produk]);
        }
    }
    ...
    public function report(){
        ...
        if(!Session::get('login')){
            ...
            return view('penjualan/tabel',['user'=>$user, 'produk'=>$produk, 'penjualan'=>$penjualan, 'detail_penjualan'=>$detail_penjualan]);
        }
    }
}
