                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li>
                                <a href="../jenis_bahan_baku"><i class="fa ti-filter"></i>Jenis Bahan Baku</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="../pembelian"><i class="menu-icon fa ti-receipt"></i>Pembelian Bahan Baku</a>                     
                    </li>
                    <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li>
                                <a href="../pembelian/report"><i class="menu-icon fa ti-receipt"></i>Pembelian Bahan Baku</a>                     
                            </li>
                            <li>
                                <a href="../pengeluaran/report"><i class="menu-icon fa ti-wallet"></i>Pengeluaran</a>                     
                            </li>
                            <li>
                                <a href="../keuangan/report"><i class="menu-icon fa ti-money"></i>Keuangan</a>                     
                            </li>
                        </ul>
                    </li>
                </ul>
